                    ...
                    <ul>
                        <li id="users_seller">
                            <a class="waves-effect" style="text-decoration: none;"
                                href="Admin Company.html">Companyr</a>
                        </li>
                                        ...
                                        <form method="POST" action="AdmineditProduct.php" enctype="multipart/form-data">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="img/<?php echo $row['Prod_image']; ?>" alt=" " height="50"
                                                            width="50">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td style="width: 20%;">
                                                        <a href="" class="table-link danger">
                                                            ...
                                                            <input type="submit" name="edit" class="btn btn-danger btn-xs"
                                                                style=margin-bottom:10px; value="Edit">
                                                            <a href="">
                                                                <input type="submit" name="delete" class="btn btn- btn-xs"
                                                                    value="Delete">
                                                            </a>
                                                        </a>
                                                    </td>
