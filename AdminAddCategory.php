...
<body>
    ...
    <form id="myform" method="POST" action="Catinsert.php">
        <main>
            <div id="app" class="container" style="padding-left: 150px;">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <label style="color: black;">Category Brand</label>
                        <input type="text" class="form-control" name="Cat_Brand">
                    </div>
                    <div class="col">

                        <label style="color: black;">Category Desc</label>
                        <input type="text" class="form-control" name="Cat_Desc">
                    </div>
                    <div class="col">

                        <label style="color: black;">Category Quantity</label>
                        <input type="text" class="form-control" name="Cat_quantity">
                    </div>
                    <div class="col">
                        <label style="color: black;">Category Image:::</label>
                        <input type="file" name="Cat_image">
                    </div>
                </div>

                <button type="submit" value="submit" class="btn btn-warning btn-lg ms-2" id="btn" name="submit"
                    style="margin-left: 300px;">Submit
                    form</button>
            </div>
            <hr>
            </div>
