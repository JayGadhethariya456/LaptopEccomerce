                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            Lenovo is one of the world's leading personal technology companies,
                                        </td>
                                        <td>
                                            <img src="img/Lenovo IdeaPad Slim 3.jpg" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Apple Inc. (formerly Apple Computer Inc.) is an American computer and
                                            consumer
                                        </td>
                                        <td>
                                            <img src="img/Apple MacBook Pro.jpg" alt="">
                                        </td>
                                        <td class="text-center">
                                            <span class="label label-success">Active</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Acer</td>
                                        <td>
                                            Acer was founded in 1976 by Stan Shih (Chinese: 施振榮),
                                        </td>
                                        <td>
                                            <img src="img/Acer Aspire 5.jpg" alt="">
                                        </td>
                                        <td class="text-center">
